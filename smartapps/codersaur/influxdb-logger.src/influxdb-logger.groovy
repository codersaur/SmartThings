...
preferences {
    ...
    section("Devices To Monitor:") {
        ...
        input "activityLightingMode", "capability.activityLightingMode", title: "Activity Lighting Mode", multiple: true, required: false
        input "activitySensor", "capability.activitySensor", title: "Activity Sensors", multiple: true, required: false
        input "airConditionerFanMode", "capability.airConditionerFanMode", title: "A/C Fan Mode", multiple: true, required: false
        input "airConditionerMode", "capability.airConditionerMode", title: "A/C Mode", multiple: true, required: false
        input "airPurifierFanMode", "capability.airPurifierFanMode", title: "Air Purifier Fan Mode", multiple: true, required: false
        input "airQualitySensor", "capability.airQualitySensor", title: "Air Quality Sensor", multiple: true, required: false
        input "alarms", "capability.alarm", title: "Alarms", multiple: true, required: false
        input "atmosphericPressureMeasurement", "capability.atmosphericPressureMeasurement", title: "Atmospheric Preassure", multiple: true, required: false
        input "audioMute", "capability.audioMute", title: "Audio Mute", multiple: true, required: false
        input "audioVolume", "capability.audioVolume", title: "Audio Volume", multiple: true, required: false
        input "batteries", "capability.battery", title: "Batteries", multiple: true, required: false
        input "bodyMassIndexMeasurement", "capability.bodyMassIndexMeasurement", title: "Body Mass Index", multiple: true, required: false
        input "bodyWeightMeasurement", "capability.bodyWeightMeasurement", title: "Body Weight", multiple: true, required: falseJust
        input "buttons", "capability.button", title: "Buttons", multiple: true, required: false
        input "bypassable", "capability.bypassable", title: "Bypass", multiple: true, required: false
        input "carbonDioxideHealthConcern", "capability.carbonDioxideHealthConcern", title: "Carbon Dioxide Health Concern", multiple: true, required: false
        input "co2s", "capability.carbonDioxideMeasurement", title: "Carbon Dioxide Detectors", multiple: true, required: false
        input "carbonMonoxideDetector", "capability.carbonMonoxideDetector", title: "Carbon Monoxide Detectors", multiple: true, required: false
        input "co2s", "capability.carbonMonoxideMeasurement", title: "Carbon Dioxide Measurement", multiple: true, required: false
        input "chime", "capability.chime", title: "Chime", multiple: true, required: false
        input "colorControl", "capability.colorControl", title: "Color Controllers", multiple: true, required: false
        input "colorTermperature", "capability.colorTermperature", title: "Color Temperature", multiple: true, required: false
        input "colors", "capability.color", title: "Colors", multiple: true, required: false
        input "colorMode", "capability.colorMode", title: "Color Mode", multiple: true, required: false
        input "consumables", "capability.consumable", title: "Consumables", multiple: true, required: false
        input "contacts", "capability.contactSensor", title: "Contact Sensors", multiple: true, required: false
        input "demandResponseLoadControl", "capability.demandResponseLoadControl", title: "Demand Response Load Control", multiple: true, required: false
        input "dewPoint", "capability.dewPoint", title: "Dew Point", multiple: true, required: false
        input "dishwasherMode", "capability.dishwasherMode", title: "Dishwasher Mode", multiple: true, required: false
        input "dishwasherOperatingState", "capability.dishwasherOperatingState", title: "Dishwasher State", multiple: true, required: false
        input "doorsControllers", "capability.doorControl", title: "Door Controllers", multiple: true, required: false
        input "drivingStatus", "capability.drivingStatus", title: "Driving Status", multiple: true, required: false
        input "dryerMode", "capability.dryerMode", title: "Dryer Mode", multiple: true, required: false
        input "dryerOperatingState", "capability.dryerOperatingState", title: "Dryer State", multiple: true, required: false
        input "dustHealthConcern", "capability.dustHealthConcern", title: "Dust Concern", multiple: true, required: false
        input "dustSensor", "capability.dustSensor", title: "Dust Sensor", multiple: true, required: false
        input "elevatorCall", "capability.elevatorCall", title: "Elevator Call", multiple: true, required: false
        input "energyMeters", "capability.energyMeter", title: "Energy Meters", multiple: true, required: false
        input "equivalentCarbonDioxideMeasurement", "capability.equivalentCarbonDioxideMeasurement", title: "Equiv C02", multiple: true, required: false
        input "estimatedTimeOfArrival", "capability.estimatedTimeOfArrival", title: "ETA", multiple: true, required: false
        input "fanOscillationMode", "capability.fanOscillationMode", title: "Fan Mode", multiple: true, required: false
        input "fanSpeed", "capability.fanSpeed", title: "Fan Speed", multiple: true, required: false
        input "feederOperatingState", "capability.feederOperatingState", title: "Feeder State", multiple: true, required: false
        input "feederPortion", "capability.feederPortion", title: "Feeder Portion", multiple: true, required: false
        input "filterState", "capability.filterState", title: "Filter State", multiple: true, required: false
        input "filterStatus", "capability.filterStatus", title: "Filter Status", multiple: true, required: false
        input "fineDustSensor", "capability.fineDustSensor", title: "Fine Dust", multiple: true, required: false
        input "firmwareUpdate", "capability.firmwareUpdate", title: "Firmware Update", multiple: true, required: false
        input "formaldehydeMeasurement", "capability.formaldehydeMeasurement", title: "Formaldehyde", multiple: true, required: false
        input "gasDetector", "capability.gasDetector", title: "Gas Detector", multiple: true, required: false
        input "gasMeter", "capability.gasMeter", title: "Gas Meter", multiple: true, required: false
        input "healthCheck", "capability.healthCheck", title: "Health Check", multiple: true, required: false
        input "humidifierMode", "capability.humidifierMode", title: "Humidifier Mode", multiple: true, required: false
        input "humidities", "capability.relativeHumidityMeasurement", title: "Humidity Meters", multiple: true, required: false
        input "illuminances", "capability.illuminanceMeasurement", title: "Illuminance Meters", multiple: true, required: false
        input "infraredLevel", "capability.infraredLevel", title: "Infrared", multiple: true, required: false
        input "locks", "capability.lock", title: "Locks", multiple: true, required: false
        input "motions", "capability.motionSensor", title: "Motion Sensors", multiple: true, required: false
        input "mediaController", "capability.mediaController", title: "Media Controller", multiple: true, required: false
        input "mediaInputSource", "capability.mediaInputSource", title: "Media Input", multiple: true, required: false
        input "moldHealthConcern", "capability.moldHealthConcern", title: "Mold Concern", multiple: true, required: false
        input "networkMeter", "capability.networkMeter", title: "Network Meter", multiple: true, required: false
        input "objectDetection", "capability.objectDetection", title: "Object Detection", multiple: true, required: false
        input "occupancySensor", "capability.occupancySensor", title: "Occupancy", multiple: true, required: false
        input "odorSensor", "capability.odorSensor", title: "Odor", multiple: true, required: false
        input "operatingState", "capability.operatingState", title: "Operating State", multiple: true, required: false
        input "ovenMode", "capability.ovenMode", title: "Oven Mode", multiple: true, required: false
        input "ovenOperatingState", "capability.ovenOperatingState", title: "Oven State", multiple: true, required: false
        input "ovenSetpoint", "capability.ovenSetpoint", title: "Oven Set Point", multiple: true, required: false
        input "panicAlarm", "capability.panicAlarm", title: "Panic Alarm", multiple: true, required: false
        input "peds", "capability.stepSensor", title: "Pedometers", multiple: true, required: false
        input "pestControl", "capability.pestControl", title: "Pest Control", multiple: true, required: false
        input "phMeters", "capability.pHMeasurement", title: "pH Meters", multiple: true, required: false
        input "powerMeters", "capability.powerMeter", title: "Power Meters", multiple: true, required: false
        input "powerSource", "capability.powerSource", title: "Power Source", multiple: true, required: false
        input "precipitationMeasurement", "capability.precipitationMeasurement", title: "Precipitation", multiple: true, required: false
        input "precipitationRate", "capability.precipitationRate", title: "Precipitation Rate", multiple: true, required: false
        input "precipitationSensor", "capability.precipitationSensor", title: "Precipitation Sensor", multiple: true, required: false
        input "presences", "capability.presenceSensor", title: "Presence Sensors", multiple: true, required: false
        input "radonHealthConcern", "capability.radonHealthConcern", title: "Radon Concern", multiple: true, required: false
        input "radonMeasurement", "capability.radonMeasurement", title: "Radon", multiple: true, required: false
        input "refrigerationSetpoint", "capability.refrigerationSetpoint", title: "Refrigeration Setpoint", multiple: true, required: false
        input "refrigeration", "capability.refrigeration", title: "Refrigeration", multiple: true, required: false
        input "relativeBrightness", "capability.relativeBrightness", title: "Brightness", multiple: true, required: false
        input "remoteControlStatus", "capability.remoteControlStatus", title: "Remote Control Status", multiple: true, required: false
        input "robotCleanerCleaningMode", "capability.robotCleanerCleaningMode", title: "Robot Cleaner Mode", multiple: true, required: false
        input "samsungTV", "capability.samsungTV", title: "Samsung TV", multiple: true, required: false
        input "scent", "capability.scent", title: "Scent", multiple: true, required: false
        input "securitySystem", "capability.securitySystem", title: "Security System", multiple: true, required: false
        ...
        input "soundDetection", "capability.soundDetection", title: "Sound Detectors", multiple: true, required: false
        input "soundPressureLevel", "capability.soundPressureLevel", title: "Sound Pressure", multiple: true, required: false
        ...
        input "temperatureAlarm", "capability.temperatureAlarm", title: "Temperature Alarm", multiple: true, required: false
        input "temperatures", "capability.temperatureMeasurement", title: "Temperature Sensors", multiple: true, required: false
        input "thermostatCoolingSetpoint", "capability.thermostatCoolingSetpoint", title: "Thermostat Cooling Point", multiple: true, required: false
        input "thermostatFanMode", "capability.thermostatFanMode", title: "Thermostat Fan", multiple: true, required: false
        input "thermostatHeatingSetpoint", "capability.thermostatHeatingSetpoint", title: "Thermostat Heating Point", multiple: true, required: false
        input "thermostatMode", "capability.thermostatMode", title: "Thermostat Mode", multiple: true, required: false
        input "thermostatOperatingState", "capability.thermostatOperatingState", title: "Thermostat State", multiple: true, required: false
        ...
        input "tV", "capability.tV", title: "TV", multiple: true, required: false
        input "tvocHealthConcern", "capability.tvocHealthConcern", title: "TVOC Concern", multiple: true, required: false
        input "tvocMeasurement", "capability.tvocMeasurement", title: "TVOC Level", multiple: true, required: false
        input "uvs", "capability.ultravioletIndex", title: "UV Sensors", multiple: true, required: false
        input "valves", "capability.valve", title: "Valves", multiple: true, required: false
        input "vehicleEngine", "capability.vehicleEngine", title: "Vehicle Engine", multiple: true, required: false
        input "vehicleFuelLevel", "capability.vehicleFuelLevel", title: "Vehicle Fuel", multiple: true, required: false
        input "vehicleInformation", "capability.vehicleInformation", title: "Vehicle Info", multiple: true, required: false
        input "vehicleOdometer", "capability.vehicleOdometer", title: "Vehicle Odometer", multiple: true, required: false
        input "veryFineDustSensor", "capability.veryFineDustSensor", title: "Very Fine Dust", multiple: true, required: false
        input "videoCamera", "capability.videoCamera", title: "Veideo Camera", multiple: true, required: false
        input "volts", "capability.voltageMeasurement", title: "Voltage Meters", multiple: true, required: false
        input "washerMode", "capability.washerMode", title: "Washer Mode", multiple: true, required: false
        input "washerOperatingState", "capability.washerOperatingState", title: "Washer State", multiple: true, required: false
        input "waterSensors", "capability.waterSensor", title: "Water Sensors", multiple: true, required: false
        input "wifiMeshRouter", "capability.wifiMeshRouter", title: "Wifi Mesh Router", multiple: true, required: false
        input "windSpeed", "capability.windSpeed", title: "Wind Speed", multiple: true, required: false
        input "windowShadeLevel", "capability.windowShadeLevel", title: "Window Shade", multiple: true, required: false
        input "windSpeed", "capability.windSpeed", title: "Wind Speed", multiple: true, required: false
        input "windowShades", "capability.windowShade", title: "Window Shades", multiple: true, required: false
        input "wirelessOperatingMode", "capability.wirelessOperatingMode", title: "Window Shades", multiple: true, required: false
    }
